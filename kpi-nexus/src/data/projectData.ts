...
// Coverage: Mar 2024 – Apr 2026 (26 months)
...
// ── 26 months of raw monthly data (Mar 2024 – Apr 2026) ──────────────────────
...
export const COMPLETION_FORECAST: ProjectForecastPoint[] = [
  ...
  { month:'May 2026', forecast:85.0,  lower:68.0,  upper:100.0 },
  { month:'Jun 2026', forecast:90.0,  lower:74.0,  upper:100.0 },
  { month:'Jul 2026', forecast:93.5,  lower:78.0,  upper:100.0 },
  { month:'Aug 2026', forecast:95.8,  lower:81.0,  upper:100.0 },
  { month:'Sep 2026', forecast:97.2,  lower:83.5,  upper:100.0 },
  { month:'Oct 2026', forecast:98.5,  lower:85.0,  upper:100.0 },
];
...
export const BUDGET_VARIANCE_FORECAST: ProjectForecastPoint[] = [
  ...
  { month:'May 2026', forecast:4.5,   lower:0.8,   upper:8.2  },
  { month:'Jun 2026', forecast:4.0,   lower:0.4,   upper:7.6  },
  { month:'Jul 2026', forecast:3.8,   lower:0.2,   upper:7.4  },
  { month:'Aug 2026', forecast:3.5,   lower:0.0,   upper:7.0  },
  { month:'Sep 2026', forecast:3.2,   lower:-0.3,  upper:6.7  },
  { month:'Oct 2026', forecast:3.0,   lower:-0.5,  upper:6.5  },
];
...
// ── Summary Statistics (latest: Apr 2026) ────────────────────────────────────
export const PROJECT_SUMMARY = {
  completionRate:   { current: 96.70,    prevMonth: 0.00,    prevYear: 100.0,   target: 95.0  },
  budgetVariance:   { current: -95.49,   prevMonth: -100.00, prevYear: -0.57,   target: 5.0   },
  delayedTaskRate:  { current: 0.000,    prevMonth: 1.000,   prevYear: 0.000,   target: 0.05  },
  budgetSpent:      { current: 556,      prevMonth: 0,       prevYear: 137395,  target: null  },
  severityScore:    { current: 97.20,    prevMonth: 87.05,   prevYear: 58.64,   target: 45.0  },
  anomalyCount:     { current: 1,        prevMonth: 0,       prevYear: 0,       target: null  },
  totalAnomalies: 11,
  peakBudgetMonth: 'Dec 2025',
  peakBudgetValue: '$1.91M',
  highSeverityMonths: 4,
